...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "hint.download": {"en": "Download", "tr": "İndir"},
    "hint.setlists": {"en": "Setlists", "tr": "Setlist indir"},
    # setlist indirici
    "dl.title": {"en": "DOWNLOAD SETLISTS", "tr": "SETLIST İNDİR"},
    "dl.all": {"en": "All setlists", "tr": "Tüm setlist'ler"},
    "dl.summary": {"en": "{have}/{total} installed · {size} left", "tr": "{have}/{total} yüklü · kalan {size}"},
    "dl.row_meta": {"en": "{year} · {n} songs", "tr": "{year} · {n} şarkı"},
    "dl.complete": {"en": "INSTALLED", "tr": "YÜKLÜ"},
    "dl.songs_label": {"en": "Songs", "tr": "Şarkı"},
    "dl.installed_label": {"en": "Installed", "tr": "Yüklü"},
    "dl.remaining_label": {"en": "To download", "tr": "İnecek"},
    "dl.free_label": {"en": "Free space", "tr": "Boş alan"},
    "dl.more": {"en": "... and {n} more", "tr": "... ve {n} şarkı daha"},
    "dl.note": {"en": "Songs are downloaded from Chorus Encore to this computer; music and charts belong to their owners.",
                "tr": "Şarkılar Chorus Encore'dan bu bilgisayara iner; müzik ve chart'lar hak sahiplerine aittir."},
    "dl.folder": {"en": "Folder: {path}", "tr": "Klasör: {path}"},
    "dl.confirm_title": {"en": "DOWNLOAD SETLIST", "tr": "SETLIST İNDİR"},
    "dl.confirm_line": {"en": "{n} songs, {size} - download now?", "tr": "{n} şarkı, {size} - şimdi indirilsin mi?"},
    "dl.all_installed": {"en": "Everything here is already installed", "tr": "Buradaki her şey zaten yüklü"},
    "dl.nospace": {"en": "Not enough free space ({need} needed, {free} free)",
                   "tr": "Yeterli boş alan yok ({need} gerekli, {free} boş)"},
    "dl.downloading": {"en": "Downloading...", "tr": "İndiriliyor..."},
    "dl.finished": {"en": "Download finished", "tr": "İndirme bitti"},
    "dl.progress": {"en": "{i} / {n} songs", "tr": "{i} / {n} şarkı"},
    "dl.bytes": {"en": "{done} / {total}", "tr": "{done} / {total}"},
    "dl.speed": {"en": "{speed}/s · ~{eta} left", "tr": "{speed}/sn · kalan ~{eta}"},
    "dl.failed_count": {"en": "{n} songs failed (will be retried next time)",
                        "tr": "{n} şarkı inemedi (bir dahaki sefere tekrar denenir)"},
    "dl.cancelling": {"en": "Cancelling...", "tr": "İptal ediliyor..."},
    "dl.cancelled": {"en": "Cancelled - {n} songs downloaded", "tr": "İptal edildi - {n} şarkı indirildi"},
    "dl.done": {"en": "{n} songs downloaded", "tr": "{n} şarkı indirildi"},
    "dl.done_failed": {"en": "{n} songs downloaded, {f} failed (check your internet)",
                       "tr": "{n} şarkı indirildi, {f} şarkı inemedi (internetini kontrol et)"},
    "hint.cancel_rest": {"en": "Cancel rest", "tr": "Kalanı iptal et"},
    # --- ana menu
    "title.play": {"en": "PLAY", "tr": "OYNA"},
    "title.import": {"en": "IMPORT SONG", "tr": "ŞARKI EKLE"},
    "title.download": {"en": "DOWNLOAD SETLISTS", "tr": "SETLIST İNDİR"},
