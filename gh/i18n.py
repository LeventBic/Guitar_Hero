...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "imp.btn_cancel": {"en": "CANCEL REMAINING", "tr": "KALANI İPTAL ET"},
    ...
    "imp.cancelling": {"en": "Finishing the current song, the rest is cancelled.",
                       "tr": "Geçerli şarkı bitiriliyor, kalanlar iptal edildi."},
    "imp.done_title": {"en": "{n} song(s) added", "tr": "{n} şarkı eklendi"},
    "imp.done_failed": {"en": ", {n} failed", "tr": ", {n} başarısız"},
    "imp.done_sub": {"en": "Your songs are in the song list (marked AUTO).",
                     "tr": "Şarkılarınız şarkı listesinde (OTO işaretli)."},
